...
const adminReportsRoute = createRoute({ getParentRoute: () => adminRoute, path: "reports", component: lazyRouteComponent(() => import("@/pages/admin/AdminReportsPage"), "AdminReportsPage") });
...
const adminNavigationRoute = createRoute({ getParentRoute: () => adminRoute, path: "navigation", component: lazyRouteComponent(() => import("@/pages/admin/AdminNavigationPage"), "AdminNavigationPage") });
...
const routeTree = rootRoute.addChildren([
  ...
  adminRoute.addChildren([adminIndexRoute, adminOrdersRoute, adminProductsRoute, adminCustomersRoute, adminCategoriesRoute, adminCouponsRoute, adminReportsRoute, adminAppearanceRoute, adminNavigationRoute, adminSettingsRoute]),
]);
