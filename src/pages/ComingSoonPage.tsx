...
export function ComingSoonPage({ title }: { title: string }) {
  return (
    <div className="container-site flex min-h-[60vh] flex-col items-center justify-center text-center">
      ...
      <Link to="/" className="mt-6 inline-flex items-center gap-2 rounded-xl bg-ink px-5 py-3 text-xs font-bold text-white"><ArrowRight className="size-4" />بازگشت به خانه</Link>
    </div>
  );
}
